...
function renderSocials() {
  return (
    <div className="flex justify-center items-end gap-4 text-fs-13 font-semibold tracking-200 text-[#f2f2f2] pb-6 md:pb-0 md:pl-10 pt-4 md:pt-0 lg:pt-20">
      <div>
...
export default function Footer() {
  ...
  return (
    <>
      <footer className="m-0 w-screen md:h-[25rem] lg:h-[23rem] bg-[#141414] flex flex-col items-center mt-8">
        <div className="flex flex-col relative w-[20rem] md:w-[43rem] lg:w-[69rem]">
          <div className="flex flex-col items-center lg:flex-row justify-between md:items-start">
            <Link href="/">
              <Image
                className="pt-20"
            ...
            <div className="flex flex-col items-center md:items-start md:flex-row gap-8 text-fs-13 font-semibold tracking-200 text-[#f2f2f2] lg:pl-10 pt-10 lg:pt-20 lg:justify-end">
          ...
          <div className="lg:w-[69rem] text-center md:text-start flex justify-between items-end">
            <p className="text-fs15 text-white font-medium opacity-50 pt-10 w-[36rem]">
              Audiophile is an all in one stop to fulfill your audio needs.
              We&apos;re a small team of music lovers and sound specialists who
              are devoted to helping you get the most out of personal audio.
              Come and visit our demo facility - we&apos;re open 7 days a week.
            </p>
            {isDesktopViewport ? renderSocials() : ""}
          </div>
          ...
          {isMobileViewport ? renderSocials() : ""}
        </div>
      </footer>
    </>
  );
